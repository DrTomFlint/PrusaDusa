...
M569 P1.0 S0                                            ; physical drive 1.0 goes forwards, V scanner azimuth
M569 P1.1 S0                                            ; physical drive 1.1 goes forwards, W scanner elevation
M584 X0.0 Y0.1 Z0.2 E0.3:0.4 U0.5 V1.0 W1.1             ; set drive mapping, U will be second x carriage, V is scanner azimuth, W is scanner elevation
M350 X16 Y16 Z16 E16:16 U16 V16 W16 I1                  ; configure microstepping with interpolation
M92 X200.00 Y200.00 Z400.00 E837.00:837.00 U200.00 V200.00 W200.00     ; set steps per mm
M566 X900.00 Y900.00 Z200.00 E600.00 600.00 U900.00 V900.00 W900.00       ; set maximum instantaneous speed changes (mm/min), don't decel if change less than this
M203 X6000.00 Y6000.00 Z1000.00 E10000.00:10000.00 U6000.00 V6000.00 W6000.00 ; set maximum speeds (mm/min)
M201 X1000.00 Y1000.00 Z250.00 E3000.00:3000.00 U1000.00 V1000.00 W1000.00      ; set accelerations (mm/s^2)
M906 X1200 Y1200 Z1200 E800:800 U1200 V600 W600 I50                    ; set motor currents (mA) and motor idle factor in per cent
M84 S30                                                 ; Set idle timeout

; Axis Limits
M208 X-47 Y0 Z-1 U0 V-8000 W-8000 S1                                        ; set axis minima
M208 X251 Y210 Z238 U298 V8000 W8000 S0                                  ; set axis maxima
...
M557 X145:245 Y5:205 P3                                 ; define mesh grid
...
G10 P0 X0.40 Y0 Z-0.05                                 ; set tool 0 axis offsets
G10 P0 R0 S0                                            ; set initial tool 0 active and standby temperatures to 0C

M563 P1 S"Right" D1 H2 F2 X3                            ; P = tool 1, S = name Right, D = drive 1, H = heater 2, F = fan 2, X3 = map X to U
G10 P1 X0 Y-0.35 Z-0.20                                 ; set tool 1 axis offsets, use X offset since U is already mapped to X
